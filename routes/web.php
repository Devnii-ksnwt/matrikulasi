...
Route::get('admin/games/tutorial', fn () => view('tutorial'));
Route::get('admin/games/tutorial/penilaian', fn () => view('penilaian'));
Route::get('admin/games/tutorial/penilaian/input', fn () => view('input'));
